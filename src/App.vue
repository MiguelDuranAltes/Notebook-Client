        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" v-if="store.state.user.logged">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <router-link v-if="isAdmin" class="dropdown-item" to="/users" active-class="active">
                  Lista de usuarios
                </router-link>
              </li>
              <li>
...
export default {
  ...
  computed: {
    isAdmin() {
      // Llama a auth.isAdmin() cada vez que se acceda a isAdmin, lo que permitirá que sea reactivo, poniendolo en data no me iba
      return auth.isAdmin();
    }
  },
  methods: {
